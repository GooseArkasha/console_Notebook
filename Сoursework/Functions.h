...
void DeliteContact(vector <Contact> &vec);	//Функция удаляет заданную пользователем запись
...
void DeliteAllContacts(vector <Contact> &vec);	//Функция удаляет все записи, хранящиесе я списке



//******************Прототипы функций для работы со списком СОБЫТЕЙ*************************
